...
export default function AddComment() {
  ...
  async function handleAddComment(e) {
    ...
    try {
      ...
      console.log("Ocorreu um erro ao adicionar comentário:", error)
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-6 md:p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-800">Adicionar Comentário</h1>
              <p className="text-slate-600 mt-1">Compartilhe sua opinião sobre esta tarefa</p>
            </div>
          </div>
          ...
          {successMessage ? (
            ...
            <form onSubmit={handleAddComment} className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Seu Comentário</label>
                <textarea
                  value={comment}
